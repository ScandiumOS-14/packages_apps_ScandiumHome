...
public class LockScreenClock extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mClockFontPref = findPreference("android.theme.customization.lockscreen_clock_font");

        mClockStyle = findPreference("clock_style");
        if (mClockStyle != null) {
            mClockStyle.setOnPreferenceChangeListener(this);
        }
        if (mClockFontPref != null) {
        ...
        if (mLockScreenWidgetsEnabledPref != null) {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.lockscreen_clock) {
